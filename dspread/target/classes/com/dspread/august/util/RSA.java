...
public class RSA {
    ...
    public byte[] encrypt(byte[] plainTextData) throws Exception {
        ...
        if(publicKey == null) {
            ...
            try {
                //PKCS1Padding
                cipher = Cipher.getInstance("RSA/None/NoPadding", new BouncyCastleProvider());
    ...
    private static RSAPrivateKey getPrivateKey(String modulus, String publicExponent) {
...
//        RSAPrivateKey privateKey = getPrivateKey("", "010001");
//        Cipher cipher = null;
//        byte[] cipherData = Util.HexStringToByteArray("");
//        try {
//            cipher = Cipher.getInstance("RSA/None/NoPadding", new BouncyCastleProvider());
//            cipher.init(2, privateKey);
//            byte[] output = cipher.doFinal(cipherData);
//            Log.d("pos",Util.byteArray2Hex(output));
//        } catch (Exception var5) {
//            Log.d("pos",var5.toString());
//
//        }
